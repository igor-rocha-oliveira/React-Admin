...
const Dashboard = () => {
    ...
    <Box m="20px">
        <Box display="flex" justifyContent="space-between" alignItems="center">
            ...
            <Box>
                <Button sx={{
                    backgroundColor: colors.blueAccent[700], color: colors.grey[100], fontSize: "14px", fontWeight: "bold", padding: "10px 20px",
                }}>
        ...
        >
            ...
            <Box gridColumn="span 3" backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center">
                <StatBox title="1,325,134" subtitle="Trafic Inbound" progress="0.80" increase="+43%" icon={<TrafficIcon sx={{color: colors.greenAccent[600], fontSize: "26px"}}/>}/>
            </Box>
                    ...
                    <Box>
                        <IconButton>
                            <DownloadOutlinedIcon
                                sx={{
                                fontSize: "25px", color: colors.greenAccent[500]
                                }}
                            />
                        </IconButton>
                    </Box>
